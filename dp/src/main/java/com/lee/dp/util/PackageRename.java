...
public class PackageRename {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (File srcFile : srcFiles) {
      ...
      List<String> dstLines = new LinkedList<>();
  ...
  private static final EncodingDetect DETECT = new EncodingDetect();
  ...
  static class Replacement {
    ...
    private final String originalPathFactor;
    private final String alternativePathFactor;

    private final String originalPackFactor;
    private final String alternativePackFactor;

    /**
     * @param  originalPrefix e.g. com.example
     * @param  alternativePrefix e.g. io.downgoon
     */
