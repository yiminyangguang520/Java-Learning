...
public class CompletableFutureInAction {
  ...
  public static void main(String[] args) throws ExecutionException, InterruptedException {
    ...
    CompletableFuture<Double> future1 = CompletableFuture.supplyAsync(CompletableFutureInAction::get);
    ...
    List<Double> collect = futures.stream().parallel().map(f -> f.join()).collect(Collectors.toList());
