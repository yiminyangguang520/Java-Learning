...
/**
 * This class manages various state transitions based on the event The superclass AbstractStateTransitionsManager calls the two methods initializeState and
