...
public class MoviesService {
  ...
  public MoviesService() {
    ...
    movies.add(new Movie("Spider-Man: Into the Spider-Verse", "2018", Arrays.asList(new Actor("Shameik Moore"), new Actor("Jake Johnson"), new Actor("Hailee Steinfeld")),
    ...
    movies.add(new Movie("Avengers: Infinity War", "2018", Arrays.asList(new Actor("Robert Downey Jr."), new Actor("Chris Hemsworth"), new Actor("Mark Ruffalo")),
        "As the Avengers and their allies have continued to protect the world from threats too large for any one hero to handle, a new danger has emerged from the cosmic shadows: Thanos. A despot of intergalactic infamy, his goal is to collect all six Infinity Stones, artifacts of unimaginable power, and use them to inflict his twisted will on all of reality. Everything the Avengers have fought for has led up to this moment, the fate of Earth and existence has never been more uncertain."));
    movies.add(new Movie("Captain America: Civil War", "2016", Arrays.asList(new Actor("Chris Evans"), new Actor("Scarlett Johansson"), new Actor("Anthony Mackie")),
    ...
    movies.add(new Movie("Ant-Man ", "2015", Arrays.asList(new Actor("Paul Rudd"), new Actor("Michael Douglas"), new Actor("Evangeline Lilly")),
