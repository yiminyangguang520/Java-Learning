package com.lee.gateway.service.serviceimpl;
...
import com.lee.gateway.repository.JwtTokenRepository;
import com.lee.gateway.repository.UserRepository;
import com.lee.gateway.security.JwtTokenProvider;
  ...
  public String login(String username, String password) {
    try {
      ...
      String token = jwtTokenProvider.createToken(username, user.getRole().stream()
          .map((Role role) -> "ROLE_" + role.getRole())
