...
function subArticle(status) {
  ...
  var url = $('#articleForm #cid').val() != '' ? '/admin/article/modify'
...
var textarea = $('#text'),
    toolbar = $(
        '<div class="markdown-editor" id="md-button-bar" />').insertBefore(
        textarea.parent())
preview = $('<div id="md-preview" class="md-hidetab" />').insertAfter(
    '.markdown-editor');
