...
public abstract class AbstractCoreSQL<T> {
  ...
  private AbstractCoreSQL.SQLStatement sql = new AbstractCoreSQL.SQLStatement();
  ...
  public T UPDATE(String table) {
    this.sql().statementType = AbstractCoreSQL.SQLStatement.StatementType.UPDATE;
  ...
  public T INSERT_INTO(String tableName) {
    this.sql().statementType = AbstractCoreSQL.SQLStatement.StatementType.INSERT;
  ...
  public T SELECT(String columns) {
    this.sql().statementType = AbstractCoreSQL.SQLStatement.StatementType.SELECT;
  ...
  public T DELETE_FROM(String table) {
    this.sql().statementType = AbstractCoreSQL.SQLStatement.StatementType.DELETE;
    this.sql().tables.add(table);
    return this.getSelf();
  }
  ...
  private AbstractCoreSQL.SQLStatement sql() {
    return this.sql;
  }
  ...
  private static class SQLStatement {
    ...
    AbstractCoreSQL.SQLStatement.StatementType statementType;
    ...
    private void sqlClause(AbstractCoreSQL.SafeAppendable builder, String keyword, List<String> parts, String open, String close, String conjunction) {
      if (!parts.isEmpty()) {
        if (!builder.isEmpty()) {
          builder.append("\n");
        }
    ...
    private void multiValueSqlClause(AbstractCoreSQL.SafeAppendable builder, String keyword, List<List<String>> multiParts, String open, String close,
      String conjunction) {
    ...
    private String selectSQL(AbstractCoreSQL.SafeAppendable builder) {
      if (this.distinct) {
    ...
    private void joins(AbstractCoreSQL.SafeAppendable builder) {
    ...
    private String insertSQL(AbstractCoreSQL.SafeAppendable builder) {
    ...
    private String deleteSQL(AbstractCoreSQL.SafeAppendable builder) {
      this.sqlClause(builder, "DELETE FROM", this.tables, "", "", "");
      this.sqlClause(builder, "WHERE", this.where, "(", ")", " AND ");
      return builder.toString();
    }

    private String updateSQL(AbstractCoreSQL.SafeAppendable builder) {
    ...
    public String sql(Appendable a) {
      AbstractCoreSQL.SafeAppendable builder = new AbstractCoreSQL.SafeAppendable(a);
  ...
  private static class SafeAppendable {
    ...
    public AbstractCoreSQL.SafeAppendable append(CharSequence s) {
      try {
