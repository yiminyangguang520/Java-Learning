...
public class KafkaProducerConfig {
  ...
  private final Pattern bytePattern = Pattern.compile(".*-bytes");

  private final Pattern strPattern = Pattern.compile("reflectoring-.*");
  ...
  public RoutingKafkaTemplate routingTemplate(GenericApplicationContext context) {
    ...
    map.put(bytePattern, bytesPF);
    map.put(strPattern, stringPF);
