...
/**
 * @author yuanpb
 * @version 创建时间：2018年4月25日 上午10:04:30 类说明：数据过滤，切面处理类
 */
@Aspect
@Component
public class DataFilterAspect {
  ...
  @Pointcut("@annotation(org.shiro.security.common.annotation.DataFilter)")
  ...
  public void dataFilter(JoinPoint point) throws Throwable {
    ...
    throw new ShiroException("数据权限接口，只能是Map类型参数，且不能为NULL");
  }
