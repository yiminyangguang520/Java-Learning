...
public class ApplicationTests {
  ...
  public void testDoSelectPageInJDK7() throws Exception {
    Page<Institute> page = PageHelper.startPage(2, 20).doSelectPage(() -> instituteMapper.findAll());
  ...
  public void testDoSelectPageInfoInJDK7() throws Exception {
    PageInfo<Institute> pageInfo = PageHelper
      .startPage(0, 20)
      .doSelectPageInfo(() -> instituteMapper.findAll());
  ...
  public void testDoSelectPageInfoJDK8() throws Exception {
    PageInfo<Institute> pageInfo = PageHelper.startPage(2, 20)
      .doSelectPageInfo(() -> instituteMapper.findAll());
