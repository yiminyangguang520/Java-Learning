...
public class SpringRedisCacheApplicationTests {
  ...
  public void testUser() throws Exception {
    ...
    String mapString = "";
//    String mapString = (String) redisTemplate.opsForValue().get("user:" + ID);
...
//    mapString = (String) redisTemplate.opsForValue().get("user:" + ID);
//    assertThat(mapString).isEqualTo(
...
//    assertThat(mapString).isNullOrEmpty();
  ...
  public void testAddress() throws Exception {
    ...
    String mapString = (String) redisTemplate.opsForValue().get("address:" + ID);
    assertThat(mapString).isEqualTo(
    ...
    mapString = (String) redisTemplate.opsForValue().get("address:" + ID);
    assertThat(mapString).isEqualTo(
        "[\"org.jdonee.cooking.domain.Address\",{\"id\":1,\"province\":\"hunan\",\"city\":\"loudi\",\"zipcode\":\"000000\"}]");
