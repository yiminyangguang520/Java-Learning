...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(final HttpSecurity http) throws Exception {
    ...
    // NOTE: Cannot use http antMatchers expressions, and expressionHandler at the same time
    // as http antMatchers expressions take precedence.
//        http
//                .authorizeRequests()
//                .antMatchers("/events/")
//                .access("@customWebExpression.isLocalHost(authentication, request) and hasRole('ADMIN')");
...
/*        http.authorizeRequests()
                ...
                .antMatchers("/events/")
                    .access("@webChecker.isLocalHost(authentication, request) and hasRole('ADMIN')");
