...
public class EventsController {
  ...
  /**
   * We add this method for demonstrating incorporating method parameters with Spring Security's @PreAuthorize based security.
   */
  ...
  /**
   * Populates the form for creating an event with valid information. Useful so that users do not have to think when filling out the form for testing.
   */
