...
-- local reference com.packtpub.springsecurity.web.access.expression.CustomWebSecurityExpressionRoot
...
-- insert into security_filtermetadata(id,ant_pattern,expression,sort_order) values (180, '/**','hasRole("ADMIN")',80);
