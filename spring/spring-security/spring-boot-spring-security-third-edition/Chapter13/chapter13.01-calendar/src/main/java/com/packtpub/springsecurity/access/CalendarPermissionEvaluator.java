...
public final class CalendarPermissionEvaluator implements PermissionEvaluator {
  ...
  /**
   * This method encapsulates our logic of determining if the current user has access to an {@link Event}. If we were securing other domain objects, the logic could be
   * added to here as well.
   *
