...
public class SpringSecurityUserContextImpl implements UserContext {
  ...
  @Autowired
  public SpringSecurityUserContextImpl(CalendarService calendarService, UserDetailsService userDetailsService) {
  ...
  public CalendarUser getCurrentUser() {
    ...
    if (result == null) {
      throw new IllegalStateException("Spring Security is not in synch with CalendarUsers. Could not find user with email " + email);
    }
    return result;
  }
