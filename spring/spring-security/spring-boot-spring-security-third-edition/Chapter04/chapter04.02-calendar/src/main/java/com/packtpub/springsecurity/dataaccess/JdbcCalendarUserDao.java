...
public class JdbcCalendarUserDao implements CalendarUserDao {
  ...
  public int createUser(final CalendarUser userToAdd) {
    ...
    this.jdbcOperations.update((Connection connection) -> {
  ...
  /**
   * Create a new RowMapper that resolves {@link CalendarUser}'s given a column label prefix. By allowing the prefix to be specified we can reuse the same {@link
   * RowMapper} for joins in other tables.
   *
   * @author Rob Winch
   */
