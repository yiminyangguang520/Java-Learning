...
/**
 * A utility class that can be used to convert passwords to use Sha256 without any salt. This uses Spring Security's old {@link PasswordEncoder} interface. Typically
 * applications should prefer the new crypto module's PasswordEncoder as demonstrated in {@link CryptoSha256PasswordEncoderMain}.
 *
 * @author Rob Winch
...
public class Sha256PasswordEncoderMain {
  ...
  /**
   * Encode a single password if supplied as args[0] Otherwise, encode the standard passwords:
