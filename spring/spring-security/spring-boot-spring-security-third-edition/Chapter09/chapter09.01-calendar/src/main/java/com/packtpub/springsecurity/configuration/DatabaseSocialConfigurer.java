...
/**
 * Concrete implementation of {@link SocialConfigurer} with convenient default implementations of methods. Specifically connecting our dataSource with the provider
 * connection in order to save OAuth2 attribute data into our local database.
 *
 * @author mickknutson
 */
