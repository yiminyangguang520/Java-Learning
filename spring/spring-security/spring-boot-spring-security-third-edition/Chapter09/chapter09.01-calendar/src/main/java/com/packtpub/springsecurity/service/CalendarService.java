...
public interface CalendarService {
   ...
   * @return a List of {@link CalendarUser}s that have an email that starts with given partialEmail. The returned value will never be null. If no results are found an
...
//            "principal.id == returnObject.attendee.id")
   ...
   * @return a non-null {@link List} of {@link Event}'s intended for the specified {@link CalendarUser}. If the {@link CalendarUser} does not exist an empty List will be
   * returned.
   */
