...
public class WelcomeController {
  ...
  /**
   * Populates a {@link HttpServletRequest} attribute named usernameContainsUser for any URL processed by this controller. The result is based upon if the username
   * contains "user".
   *
   * @param authentication Contains the current {@link Authentication} object. This is a more simple way of obtaining the Authentication from {@link
  ...
  /**
   * Populates a {@link HttpServletRequest} attribute named showAdminLink for any URL processed by this controller. The result is based upon if the user has access to the
   * URL /admin/. This demonstrates if you are not using JSP tags how you can leverage the http.authorizeRequests() mappings.
   *
   * @param authentication Contains the current {@link Authentication} object. This is a more simple way of obtaining the Authentication from {@link
   * SecurityContextHolder#getContext()}.
   */
