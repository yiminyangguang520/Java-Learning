...
public class JpaTokenRepositoryCleaner implements Runnable {
   ...
   * @param tokenValidityInMs used to calculate when a token is expired. If the {@link #run()} method is invoked, tokens older than this amount of time will be deleted.
