 ...
 * href="http://static.springsource.org/spring/docs/3.1.x/spring-framework-reference/html/scheduling.html">Spring's scheduling abstraction</a>.
 * </p>
 *
 * @author Rob Winch
 */
public final class JdbcTokenRepositoryImplCleaner implements Runnable {
  ...
  /**
   * @param jdbcOperations the {@link JdbcOperations} used to perform the cleanup. Cannot be null.
