 ...
 * </p>
 * <p>
 * The implementation relies on Spring's {@link RequestContextHolder} to populated. In our application, we choose to enable this by adding the in our web.xml as shown
 * below. The dependency on spring-web is not an issue since spring-security-web already depends on spring-web and we are implementing an interface in
 * spring-security-web.
 * </p>
 *
 * <p>
