...
import com.svlada.session.security.config.authentication.RestAuthenticationEntryPoint;
import com.svlada.session.security.config.authentication.SessionAuthenticationSuccessHandler;
