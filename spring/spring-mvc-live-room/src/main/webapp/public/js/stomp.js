...
(function () {
  ...
  Frame = (function () {
    ...
    Frame.unmarshall = function (datas) {
      ...
      if (last_frame === Byte.LF || (last_frame.search(
              RegExp("" + Byte.NULL + Byte.LF + "*$"))) !== -1) {
          ...
          return function () {
            ...
            if (delta > ttl * 2) {
              if (typeof _this.debug === "function") {
                _this.debug("did not receive server activity for the last "
                    + delta + "ms");
              }
