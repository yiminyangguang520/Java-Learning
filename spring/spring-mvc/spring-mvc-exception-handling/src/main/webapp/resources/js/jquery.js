  ...
  jQuery.event = {
    ...
    trigger: function (event, data, elem, onlyHandlers) {
      ...
      var type = event.type || event,
          namespaces = [],
          cache, exclusive, i, cur, old, ontype, special, handle, eventPath,
          bubbleType;
    ...
    dispatch: function (event) {
      ...
      if (delegateCount && !event.target.disabled && !(event.button
          && event.type === "click")) {
    ...
    off: function (types, selector, fn) {
      if (types && types.preventDefault && types.handleObj) {
        ...
        jQuery(types.delegateTarget).off(
            handleObj.namespace ? handleObj.type + "." + handleObj.namespace
                : handleObj.type,
            handleObj.selector,
            handleObj.handler
        );
  ...
  jQuery.extend({
    clone: function (elem, dataAndEvents, deepDataAndEvents) {
      var srcElements,
          ...
          clone = jQuery.support.html5Clone || !rnoshimcache.test("<"
              + elem.nodeName) ?
              elem.cloneNode(true) :
              shimCloneNode(elem);
      ...
      if (extra !== "border") {
        for (; i < len; i++) {
          ...
          if (extra === "margin") {
            ...
            val -= parseFloat(jQuery.css(elem, "border" + which[i] + "Width"))
                || 0;
          }
        }
      }
    ...
    if (jQuery.isArray(obj)) {
      ...
      jQuery.each(obj, function (i, v) {
        if (traditional || rbracket.test(prefix)) {
          ...
          buildParams(prefix + "[" + (typeof v === "object" || jQuery.isArray(v)
              ? i : "") + "]", v, traditional, add);
        }
      });
  ...
  jQuery.fx.prototype = {
    ...
    custom: function (from, to, unit) {
      ...
      t.saveState = function () {
        if (self.options.hide && jQuery._data(self.elem, "fxshow" + self.prop)
            === undefined) {
    ...
    hide: function () {
      ...
      this.options.orig[this.prop] = jQuery._data(this.elem, "fxshow"
          + this.prop) || jQuery.style(this.elem, this.prop);
